...
const informationBox = [
  ...
  //{
  //  title: 'All IRC CNPP services are delivered free of charge to participating small businesses. ',
  //  icon: (
  //    <CurrencyDollarIcon className="invisible h-0 w-0 flex-initial text-sbaYellow lg:visible lg:h-32 lg:w-32" />
  //  ),
  //  description: [
  //    'Stay updated with CNPP – Subscribe!',
  //  ],
  //},
 // {
